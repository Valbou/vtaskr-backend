...
class RightManager:
    ...
    def create_right(
        self, session, user_id: str, group_id: str, right: Right
    ) -> Right | None:
    ...
    def get_right(self, session, user_id, right_id) -> Right | None:
    ...
    def update_right(
        self, session, user_id: str, right: Right, roletype: RoleType
    ) -> bool:
