...
class RoleTypeManager:
    ...
    def create_custom_roletype(
        self, session, name: str, group_id: str
    ) -> tuple[RoleType, bool]:
        """Create a specific roletype"""
    ...
    def get_roletype(self, session, user_id: str, roletype_id: str) -> RoleType | None:
    ...
    def update_roletype(self, session, user_id: str, roletype: RoleType) -> bool:
    ...
    def delete_roletype(self, session, user_id: str, roletype: RoleType) -> bool:
