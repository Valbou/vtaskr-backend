...
Revision ID: d73b8847ad71
Revises:
Create Date: 2024-11-30 16:33:17.998789
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("telegram", sa.String(length=90), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("request_type", requesttype_enum, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("type", messagetype_enum, nullable=False),
        sa.ForeignKeyConstraint(
            ["contact_id"],
            ["contacts.id"],
            name="fk_subscription_contact_id",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "name", "type", "contact_id", name="subscriptions_contact_id"
        ),
    )
    op.create_index(
        "subscriptions_contact_index",
        "subscriptions",
        ["name", "type", "contact_id"],
        unique=True,
    )
    op.create_table(
        "taskstags",
...
def downgrade() -> None:
    ...
    op.drop_index("subscriptions_contact_index", table_name="subscriptions")
